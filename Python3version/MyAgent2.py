...
##        print ('run_RP_PU')
    ...
    def START_HW(b_context='status:starting_game planning_unit:none',
        ...
        b_plan_unit_order.set('counter:first first:HW second:RP third:AK fourth:end') ######## new buffer
        b_context.modify(status='occupied')
        print ('run_HW_PU')
...
######################### these manage the sequence if it is an ordered planning unit stored in buffer
    ...
    def setup_ordered_planning_unit(b_plan_unit='unit_task:?unit_task state:begin_sequence ptype:ordered'):
    ...
    def request_second_unit_task(b_plan_unit='unit_task:?unit_task state:running',
                                 ...
                                 b_plan_unit_order='counter:?counter first:?counter second:?second third:?third fourth:?fourth'):
        b_plan_unit_order.modify('counter:?second')
        b_plan_unit.modify(state='running')
